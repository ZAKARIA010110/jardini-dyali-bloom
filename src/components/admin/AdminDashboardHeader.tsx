...
export const AdminDashboardHeader: React.FC = () => {
  ...
  return (
    <header className={`flex h-16 shrink-0 items-center gap-3 border-b bg-white/90 backdrop-blur-md px-4 lg:px-6 sticky top-0 z-40 ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
